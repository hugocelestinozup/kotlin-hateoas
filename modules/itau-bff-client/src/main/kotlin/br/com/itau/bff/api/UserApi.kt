...
interface UserApi {
    ...
    @ApiResponses(
        value = [ApiResponse(code = 201, message = "Created", response = UserResponse::class),
            ApiResponse(code = 400, message = "Bad request", response = UserResponse::class),
            ApiResponse(code = 500, message = "Internal error to create user", response = UserResponse::class)]
    )
    ...
    @ApiResponses(
        value = [ApiResponse(code = 200, message = "Ok", response = UserResponse::class),
